    ...
    public class InventoryController : MonoBehaviour
    {
       ...
       public void LoadInitialItems()
        ...
        public void Update()
        {
            ...
            //inventoryData.SaveItems();//this will save item everytime
            /*foreach (var item in GM.itemsToTransfer)
            {
                initialItems.Add(item);
            }*/
        ...
        public void CheckifBuildingbeforeQuit()
        {
            ...
            //{
            //    BackAllCurrentlyItem();
            //    inventoryData.SaveItems();//if there is an on going build and the player quits, the items will be back in the inventory
            //}
        }

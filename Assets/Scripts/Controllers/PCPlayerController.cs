...
namespace PC
{
    public class PCPlayerController : MonoBehaviour
    {
        ...
        [SerializeField]
        private InventoryController InventCon;
        ...
        public void ClearPCs(int index)
        {
            ...
            {
                PCpage.UpdateData(item.Key, item.Value.PC.PCImage, item.Value.PC.PCName, item.Value.PC.TestStatus);
        ...
        private void HandleDescriptionRequest(int PCindex)
        {
            ...
            PCitems.PCName, PCitems.PCPrice.ToString(), PCitems.Case.Name, PCitems.Motherboard.Name, PCitems.CPU.Name, PCitems.CPUFan.Name, PCitems.RAM.Name, PCitems.GPU.Name, PCitems.STORAGE.Name, PCitems.PSU.Name, PCitems.TestStatus);
            PCIndexOutside = PCindex;
        }
